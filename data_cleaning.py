...
def data_cleaner(movies_file, ratings_file):
    ...
    # saving cleaned and reduced movies
    movies_df.to_csv('movies_cleaned_and_reduced.csv')
    ratings_df.to_csv('ratings_cleaned_and_reduced.csv')
